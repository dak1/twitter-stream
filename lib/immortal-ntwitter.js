    ...
    immortalStream.resurrectStream = function() {
        self.stream(method, params, function(stream) {
            ...
            .on('error', function(error) {
                /*if ( error != 'http') {
                    //console.log( 'tcp/ip error' + error + ' sleep ' + immortalStream.networkErrorSleepRange.current );
                    console.log( 'tcp/ip error' );
                    console.log( error );
                    console.log( 'sleep' );
                    console.log( immortalStream.networkErrorSleepRange.current );
                    ...
                    console.log( error );
                    console.log( 'sleep' );
                    console.log( immortalStream.httpErrorSleepRange.current );
